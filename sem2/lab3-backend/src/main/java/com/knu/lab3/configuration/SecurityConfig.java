package com.knu.lab3.configuration;
...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/bill/*").permitAll()
                .antMatchers(HttpMethod.POST, "/bill").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/bill/*").hasRole("ADMIN")
                .antMatchers(HttpMethod.PATCH, "/bill/**").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/registration").hasRole("CLIENT")
                .and()
                .logout()
